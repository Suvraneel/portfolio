        ...
        >
            ...
            <div className="flex items-center justify-center">
                ...
                <div
                    ...
                    bg-gray-800 w-[800px] p-[1.875rem]"
                >
          <span className="tracking-wide text-lg font-normal text-justify mb-[1rem]">
            Hello! I'm Dhiraj, a third-year CS student from India, a software
            developer who likes to build stuff that makes a difference in the
            world.
            <br/>I usually work on <b>Android development</b>,{" "}
              <b>web development</b>, and <b>Solana blockchain</b>.<br/>
            <br/>
            I believe in public learning, and I am constantly eager to learn new
            things and enjoy sharing what I have learned with others. I love
            interacting with folks and helping community members is what I like
            to do daily.
            <br/>
            <br/>I love to{" "}
              <a href={talks}>
            ...
            students towards programming, open source, and building tech
            communities.
            <br/>
            <br/>
            <ul className="list-disc">
              ...
              <li>
                <a href={"https://github.com/solana-developers/solana-grants/"}>
              ...
              <li>
                A{" "}
                  <a href={"https://githubcampus.expert/cdhiraj40/"}>
                  <b>
              ...
              <li>
                Co-founder of{" "}
                  <a href={"https://github.com/cerrituscoderscomm"}>
                  <b>
                    <u>Cerritus Coders</u>
                  </b>
                </a>
